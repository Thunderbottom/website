...
2. **Start with temporary tools**: Use `nix shell` or `nix run` to try software without installing. A list of all the official packages can be found [here](https://search.nixos.org/)
